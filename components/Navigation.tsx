...
const Navigation = ({ active }: Props) => {
    ...
    return (<nav className={mobileToggle ? 'open' : 'closed' }>
        <button className="toggle-button" aria-label="Toggle menu" onClick={setToggle}></button>
        <ul>
